...
<!-- <? include ("headers/navbar.php"); ?> -->
    <section class="add-student">
        <h1 class="title">Fee Reception  </h1>
        ...
        <div class="container">
            <form action="server.php" method="get">
                ...
                <div class="form-field col-lg-6">
                    <p class="btn btn-info" style="display: block;">Delete student by Pressing Submit.</p>
                    <input type="submit" name="remove_student" class="submit-btn btn-lg btn-danger">
                </div>
